...
export default function AddressSection() {
    ...
    return (
        <section ref={ref} className="relative md:-top-px">
            <div className="px-10 space-y-4 py-10 md:flex md:py-32 xl:p-20 md:items-center">
                ...
                >
                    <h1 className="font-bold text-base md:text-2xl xl:text-4xl xl:tracking-wider xl:mt-4">
                        PANGKALAN AMBALAN Ir. <br /> SOEKARNO - FATMAWATI
                    </h1>
                    <p className="text-[13px] md:text-base xl:text-lg font-semibold">
                        Jl. Simpang Lima No. 1, RT.02/RW.01, Mugassari, Kec.
                        Semarang Sel., Kota Semarang, Jawa Tengah{" "}
                        <br className="hidden xl:block" /> 50249
                    </p>
                ...
                <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                >
                    <figure className="w-[266px] md:w-[20rem] xl:w-[572px] h-[163px] md:h-[10rem] xl:h-[295px] border">
                        <iframe
