...
export default function Teaser() {
    return (
        <section className="h-[70vh]  bg-gradient-to-b from-secondary from-10% to-[#633FCA] text-white text-center space-y-5">
            ...
            <div className="relative md:h-full h-[30vh] md:top-[3vh]">
                <div className="absolute inset-0 flex flex-col justify-center space-y-2 z-0">
                    {Array.from({ length: 5 }).map((_, index) => (
                        <Marquee
                            ...
                            speed={25}
                            className={`text-4xl md:text-[50px] overflow-hidden tracking-wider font-bold ${
                                index % 2 === 0
                                    ? "text-slate-500"
                                    : "text-slate-400"
                            }`}
                ...
                <div className="absolute inset-0 py-5 px-9 flex items-center justify-center">
                    <div className="bg-primary p-2 md:w-[40vw] md:h-[62vh] rounded-2xl flex justify-center items-center">
                        <div className="overflow-hidden md:w-full md:h-full rounded-3xl h-44">
                            <img
                                className="w-full"
