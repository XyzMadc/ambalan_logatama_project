      ...
      <div className="bg-footer text-white py-10 px-[60px] xl:px-24 xl:py-20 rounded-tl-[70px] xl:rounded-tl-[170px] xl:flex xl:justify-between">
        <div className="xl:w-1/3 space-y-3">
          <div className="flex gap-1 xl:gap-2">
            <img className="w-14 xl:w-16" src={logoSoekarno} alt="" />
            <img className="w-14 xl:w-16" src={logoFatmawati} alt="" />
          </div>
          <div className="space-y-3">
            ...
            <p className="text-[11px] xl:text-xs tracking-wide">
              Ambalan Ir. Soekarno - Fatmawati atau yang biasa disebut dengan
              Ambalan SOEKMA. Gugusdepan 11-089 - 11-090 Pangkalan SMK Negeri 7
              Semarang.
            </p>
        ...
        <div className="mt-3 xl:w-1/3">
          <div className="space-y-1">
            <h1 className="text-xs xl:text-base font-semibold">Kontak Kami</h1>
              ...
              <div className="relative z-0 w-full group flex items-center gap-2 border-b border-white">
                ...
                <div className="flex-1 relative">
                  <input
                    ...
                    name="name"
                    id="name"
                    className="block py-2.5 px-0 w-full text-sm text-white bg-transparent focus:outline-none focus:ring-0 focus:border-none peer"
                    placeholder=" "
                    required
                  />
                  <label
